        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanManageStockCodeDefinitions = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ElasticModulus = table.Column<double>(type: "float(10)", precision: 10, scale: 3, nullable: true),
                    YieldFactorK = table.Column<double>(type: "float(10)", precision: 10, scale: 3, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Materials",
                columns: new[] { "Id", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "Density", "MaterialNumber", "ModifiedBy", "ModifiedDate", "Name", "Notes", "Status" },
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1247), null, null, 7850.0, "1.0565", null, null, "P355GH", "Pressure vessel plate according to EN10028-2", 0 },
                    { new Guid("33333333-3333-3333-3333-333333333333"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1261), null, null, 8000.0, "1.4301", null, null, "X5CrNi18-10", "EN 10028-7 stainless pressure vessel steel", 0 },
                    { new Guid("55555555-5555-5555-5555-555555555555"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1270), null, null, 7850.0, "1.0038", null, null, "S235JR", "Profile material for supports/rings", 0 },
                    { new Guid("77777777-7777-7777-7777-777777777777"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1281), null, null, 7850.0, "1.0565", null, null, "P355NH", "Normalized pressure vessel steel EN10028-3", 0 },
                    { new Guid("88888888-8888-8888-8888-888888888888"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1289), null, null, 8000.0, "1.4307", null, null, "X2CrNi18-9", "Austenitic stainless steel plate EN10028-7", 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10000000-0000-0000-0000-000000000001"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2502), null, null, 460.0, "Liquefied Natural Gas", null, null, "Methane / LNG", 0 },
                    { new Guid("10000000-0000-0000-0000-000000000002"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2516), null, null, 808.0, "Liquid Nitrogen", null, null, "Nitrogen / LIN", 0 },
                    { new Guid("10000000-0000-0000-0000-000000000003"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2523), null, null, 1141.0, "Liquid Oxygen", null, null, "Oxygen / LOX", 0 },
                    { new Guid("10000000-0000-0000-0000-000000000004"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2527), null, null, 1395.0, "Liquid Argon", null, null, "Argon / LAR", 0 },
                    { new Guid("10000000-0000-0000-0000-000000000005"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2530), null, null, 1070.0, "Liquid Carbon Dioxide", null, null, "Carbon Dioxide / LCO2", 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("40000000-0000-0000-2221-000000000004"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Teklif Hazırlama", 4, "GÖVDE BOMBE ORYANTASYON HAZIRLAMA" },
                    { new Guid("40000000-0000-0000-2221-000000000005"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Teklif Hazırlama", 5, "KRİTİK AKSESUAR LİSTESİ YAYINLAMA" },
                    { new Guid("40000000-0000-0000-2221-000000000006"), 3, 1m, true, true, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 6, "TUV Tip Onay Süreci (Tüm Projeler İçin)" },
                    { new Guid("40000000-0000-0000-2221-000000000007"), 1, 6m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 7, "Genel Tip Onay Resmi" },
                    { new Guid("40000000-0000-0000-2221-000000000008"), 3, 1m, true, true, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 8, "Onay ve kontrol süreci (TUV)" },
                    { new Guid("40000000-0000-0000-2221-000000000009"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 9, "TANK BOMBE MONTAJ RESMİ" },
                    { new Guid("40000000-0000-0000-2221-000000000010"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 10, "TANK PUL ÇAPI KONTROL" },
                    { new Guid("40000000-0000-0000-2221-000000000011"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 11, "TANK GÖVDE BOMBE KESİM RESMİ" },
                    { new Guid("40000000-0000-0000-2221-000000000012"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 12, "TANK MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2221-000000000013"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 13, "TANK REÇETESİ" },
                    { new Guid("40000000-0000-0000-2221-000000000014"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 14, "TANK AYAK TASARIMI" },
                    { new Guid("40000000-0000-0000-2221-000000000015"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 15, "TANK AYAK REÇETESİ" },
                    { new Guid("40000000-0000-0000-2221-000000000016"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 16, "BOYA GRUBU REÇETE GİRİŞ" },
                    { new Guid("40000000-0000-0000-2221-000000000017"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 17, "ETİKET GRUBU REÇETE GİRİŞ" },
                    { new Guid("40000000-0000-0000-2221-000000000018"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 18, "ETİKET TASARIMI" },
                    { new Guid("40000000-0000-0000-2221-000000000019"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Dizayn Mühendisi", 19, "Tank Manuel Hazırlanması" },
                    { new Guid("40000000-0000-0000-2221-000000000020"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Teknik Ressam", 20, "TANK KESİM RESİMLERİNİN VE LİSTELERİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2221-000000000021"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Teknik Ressam", 21, "TANK GÖVDE MONTAJ & NOZUL& DABLİN & TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2221-000000000022"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Teknik Ressam", 22, "TANK AYAK TEKNİK RESİMLERİ" },
                    { new Guid("40000000-0000-0000-2221-000000000023"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Teknik Ressam", 23, "TANK AKSESUAR TEKNİK RESİMLERİ" },
                    { new Guid("40000000-0000-0000-2221-000000000024"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222221"), "Teknik Ressam", 24, "NAKLİYE RESMİ" },
                    ...
                    { new Guid("40000000-0000-0000-2222-000000000008"), 3, 1m, true, true, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 8, "TUV Tip Onay Süreci (Tüm Projeler İçin)" },
                    { new Guid("40000000-0000-0000-2222-000000000009"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 9, "İÇ TANK BOMBE MONTAJ RESMİ" },
                    { new Guid("40000000-0000-0000-2222-000000000010"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 10, "İÇ TANK PUL ÇAPI KONTROL" },
                    { new Guid("40000000-0000-0000-2222-000000000011"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 11, "İÇ TANK GÖVDE BOMBE KESİM RESMİ" },
                    { new Guid("40000000-0000-0000-2222-000000000012"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 12, "İÇ TANK MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2222-000000000013"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 13, "İÇ TANK REÇETESİ" },
                    { new Guid("40000000-0000-0000-2222-000000000014"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 14, "İÇ TANK BORULAMA TASARIMI" },
                    { new Guid("40000000-0000-0000-2222-000000000015"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 15, "İÇ TANK BORULAMA REÇETESİ" },
                    { new Guid("40000000-0000-0000-2222-000000000016"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 16, "DIŞ TANK BOMBE MONTAJ TEKNİK RESİM" },
                    { new Guid("40000000-0000-0000-2222-000000000017"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 17, "DIŞ TANK PUL ÇAPI KONTROL" },
                    { new Guid("40000000-0000-0000-2222-000000000018"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 18, "DIŞ TANK GÖVDE BOMBE KESİM RESMİ" },
                    { new Guid("40000000-0000-0000-2222-000000000019"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 19, "DIŞ TANK MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2222-000000000020"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 20, "DIŞ TANK REÇETESİ" },
                    { new Guid("40000000-0000-0000-2222-000000000021"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 21, "İGM MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2222-000000000022"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 22, "DIŞ BORULAMA TASARIMI" },
                    { new Guid("40000000-0000-0000-2222-000000000023"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 23, "DIŞ BORULAMA REÇETESİ" },
                    { new Guid("40000000-0000-0000-2222-000000000024"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 24, "BUHARLIŞTIRICI TASARIMI" },
                    { new Guid("40000000-0000-0000-2222-000000000025"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 25, "BUHARLIŞTIRICI REÇETESİ" },
                    { new Guid("40000000-0000-0000-2222-000000000026"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 26, "İZOLASYON GRUBU REÇETE GİRİŞ" },
                    { new Guid("40000000-0000-0000-2222-000000000027"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 27, "BOYA GRUBU REÇETE GİRİŞ" },
                    { new Guid("40000000-0000-0000-2222-000000000028"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 28, "ETİKET GRUBU REÇETE GİRİŞ" },
                    { new Guid("40000000-0000-0000-2222-000000000029"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 29, "ETİKET TASARIMI" },
                    { new Guid("40000000-0000-0000-2222-000000000030"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Dizayn Mühendisi", 30, "Tank Manuel Hazırlanması" },
                    { new Guid("40000000-0000-0000-2222-000000000031"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 31, "DIŞ TANK KESİM RESİMLERİNİN VE LİSTELERİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2222-000000000032"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 32, "DIŞ TANK GÖVDE MONTAJ teknik resmi ( dış tank ring& ring sarımı & mapa yerleşimi & dablinler)" },
                    { new Guid("40000000-0000-0000-2222-000000000033"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 33, "PROFİL AYAK MONTAJ RESMİNİN HAZIRLANMASI TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2222-000000000034"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 34, "İÇ TANK BORULAMA TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2222-000000000035"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 35, "İÇ TANK KESİM RESİMLERİNİN VE LİSTELERİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2222-000000000036"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 36, "İÇ TANK GÖVDE MONTAJ& NOZUL& DABLİN & TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2222-000000000037"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 37, "İGM MONTAJ TEKNİK RESİM" },
                    { new Guid("40000000-0000-0000-2222-000000000038"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 38, "DIŞ BORULAMA  TEKNİK RESİM" },
                    { new Guid("40000000-0000-0000-2222-000000000039"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 39, "EVAP KESİM RESİMLERİNİN VE LİSTELERİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2222-000000000040"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 40, "EVAP TEKNİK RESİM" },
                    { new Guid("40000000-0000-0000-2222-000000000041"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 41, "NAKLİYE RESMİ" },
                    { new Guid("40000000-0000-0000-2222-000000000042"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222222"), "Teknik Ressam", 42, "ASBUILT RESMİ HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2223-000000000001"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teklif Hazırlama", 1, "Hesaplamalar" },
                    { new Guid("40000000-0000-0000-2223-000000000002"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teklif Hazırlama", 2, "GÖVDE BOMBE ORYANTASYON HAZIRLAMA" },
                    { new Guid("40000000-0000-0000-2223-000000000003"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teklif Hazırlama", 3, "KRİTİK AKSESUAR LİSTESİ YAYINLAMA" },
                    { new Guid("40000000-0000-0000-2223-000000000004"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teklif Hazırlama", 4, "P&ID HAZIRLAMA" },
                    { new Guid("40000000-0000-0000-2223-000000000005"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teklif Hazırlama", 5, "GAD RESMİ ÇİZİMİ" },
                    { new Guid("40000000-0000-0000-2223-000000000006"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teklif Hazırlama", 6, "GAD RESMİ ÇİZİM ONAYI" },
                    { new Guid("40000000-0000-0000-2223-000000000007"), 1, 6m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 7, "Genel Tip Onay Resmi" },
                    { new Guid("40000000-0000-0000-2223-000000000008"), 3, 1m, true, true, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 8, "TUV Tip Onay Süreci (Tüm Projeler İçin)" },
                    { new Guid("40000000-0000-0000-2223-000000000009"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 9, "TANK BOMBE MONTAJ RESMİ" },
                    { new Guid("40000000-0000-0000-2223-000000000010"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 10, "TANK PUL ÇAPI KONTROL" },
                    { new Guid("40000000-0000-0000-2223-000000000011"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 11, "TANK GÖVDE BOMBE KESİM RESMİ" },
                    { new Guid("40000000-0000-0000-2223-000000000012"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 12, "TANK MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2223-000000000013"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 13, "TANK MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2223-000000000014"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 14, "DALGAKIRAN TASARIMI" },
                    { new Guid("40000000-0000-0000-2223-000000000015"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 15, "DALGAKIRAN REÇETESİ" },
                    { new Guid("40000000-0000-0000-2223-000000000016"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 16, "ŞASE MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2223-000000000017"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 17, "ŞASE MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2223-000000000018"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 18, "TANK AYAK MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2223-000000000019"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 19, "TANK AYAK MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2223-000000000020"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 20, "KİNG PİN & MEKANİK AYAK TASARIMI" },
                    { new Guid("40000000-0000-0000-2223-000000000021"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 21, "KİNG PİN & MEKANİK AYAK REÇETESİ" },
                    { new Guid("40000000-0000-0000-2223-000000000022"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 22, "KONSOL MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2223-000000000023"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 23, "KONSOL MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2223-000000000024"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 24, "ŞASE MONTAJ SON MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2223-000000000025"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 25, "DIŞ BORULAMA TASARIMI" },
                    { new Guid("40000000-0000-0000-2223-000000000026"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 26, "DIŞ BORULAMA REÇETESİ" },
                    { new Guid("40000000-0000-0000-2223-000000000027"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 27, "DOLAP TASARIMI" },
                    { new Guid("40000000-0000-0000-2223-000000000028"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 28, "DOLAP REÇETESİ" },
                    { new Guid("40000000-0000-0000-2223-000000000029"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 29, "BOYA GRUBU REÇETE GİRİŞ" },
                    { new Guid("40000000-0000-0000-2223-000000000030"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 30, "ETİKET GRUBU REÇETE GİRİŞ" },
                    { new Guid("40000000-0000-0000-2223-000000000031"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 31, "ETİKET TASARIMI" },
                    { new Guid("40000000-0000-0000-2223-000000000032"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Dizayn Mühendisi", 32, "Tank Manuel Hazırlanması" },
                    { new Guid("40000000-0000-0000-2223-000000000033"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 33, "TANK KESİM RESİMLERİNİN VE LİSTELERİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2223-000000000034"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 34, "Şase Kesim Resimlerinin Listelerinin Hazırlanması" },
                    { new Guid("40000000-0000-0000-2223-000000000035"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 35, "Şase Teknik Resmi" },
                    { new Guid("40000000-0000-0000-2223-000000000036"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 36, "DALGAKIRAN KESİM LİSTESİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2223-000000000037"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 37, "TANK GÖVDE MONTAJ & NOZUL& DABLİN & TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2223-000000000038"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 38, "DALGAKIRAN TEKNİK RESİMLERİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2223-000000000039"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 39, "KİNG PİN & MEKANİK AYAK KESİM LİSTESİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2223-000000000040"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 40, "TANK AYAK MONTAJ TASARIMI & KİNG PİN & MEKANİK AYAK KESİM LİSTESİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2223-000000000041"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 41, "TANK AYAK MONTAJ TASARIMI & KİNG PİN & MEKANİK AYAK TEKNİK RESMİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2223-000000000042"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 42, "KONSOL MONTAJ TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2223-000000000043"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 43, "DOLAP TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2223-000000000044"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 44, "BORULAMA TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2223-000000000045"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 45, "NAKLİYE RESMİ" },
                    { new Guid("40000000-0000-0000-2223-000000000046"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222223"), "Teknik Ressam", 46, "ASBUİLT" },
                    { new Guid("40000000-0000-0000-2224-000000000001"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teklif Hazırlama", 1, "Hesaplamalar" },
                    { new Guid("40000000-0000-0000-2224-000000000002"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teklif Hazırlama", 2, "GÖVDE BOMBE ORYANTASYON HAZIRLAMA" },
                    { new Guid("40000000-0000-0000-2224-000000000003"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teklif Hazırlama", 3, "KRİTİK AKSESUAR LİSTESİ YAYINLAMA" },
                    { new Guid("40000000-0000-0000-2224-000000000004"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teklif Hazırlama", 4, "P&ID HAZIRLAMA" },
                    { new Guid("40000000-0000-0000-2224-000000000005"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teklif Hazırlama", 5, "GAD RESMİ ÇİZİMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000006"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teklif Hazırlama", 6, "GAD RESMİ ÇİZİM ONAYI" },
                    { new Guid("40000000-0000-0000-2224-000000000007"), 1, 6m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 7, "Genel Tip Onay Resmi" },
                    { new Guid("40000000-0000-0000-2224-000000000008"), 3, 1m, true, true, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 8, "TUV Tip Onay Süreci (Tüm Projeler İçin)" },
                    { new Guid("40000000-0000-0000-2224-000000000009"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 9, "İÇ TANK BOMBE MONTAJ RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000010"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 10, "İÇ TANK PUL ÇAPI KONTROL" },
                    { new Guid("40000000-0000-0000-2224-000000000011"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 11, "İÇ TANK GÖVDE BOMBE KESİM RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000012"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 12, "DIŞ TANK BOMBE MONTAJ RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000013"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 13, "DIŞ TANK PUL ÇAPI KONTROL" },
                    { new Guid("40000000-0000-0000-2224-000000000014"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 14, "DIŞ TANK GÖVDE BOMBE KESİM RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000015"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 15, "İÇ TANK MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000016"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 16, "DALGAKIRAN TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000017"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 17, "DALGAKIRAN REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000018"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 18, "İÇ TANK MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000019"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 19, "İÇ TANK İÇ BORULAMA MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000020"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 20, "İÇ TANK İÇ BORULAMA MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000021"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 21, "DIŞ TANK MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000022"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 22, "DIŞ TANK MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000023"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 23, "İGM MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000024"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 24, "İGM MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000025"), 1, 6m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 25, "DIŞ BORULAMA TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000026"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 26, "DIŞ BORULAMA REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000027"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 27, "TANK AYAK MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000028"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 28, "TANK AYAK MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000029"), 1, 6m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 29, "ŞASE MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000030"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 30, "ŞASE MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000031"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 31, "KİNG PİN & MEKANİK AYAK TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000032"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 32, "KİNG PİN & MEKANİK AYAK REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000033"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 33, "KONSOL MONTAJ TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000034"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 34, "KONSOL MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000035"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 35, "ŞASE MONTAJ SON MONTAJ REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000036"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 36, "DOLAP TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000037"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 37, "DOLAP REÇETESİ" },
                    { new Guid("40000000-0000-0000-2224-000000000038"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 38, "BOYA GRUBU REÇETE GİRİŞ" },
                    { new Guid("40000000-0000-0000-2224-000000000039"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 39, "ETİKET GRUBU REÇETE GİRİŞ" },
                    { new Guid("40000000-0000-0000-2224-000000000040"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 40, "ETİKET TASARIMI" },
                    { new Guid("40000000-0000-0000-2224-000000000041"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Dizayn Mühendisi", 41, "Tank Manuel Hazırlanması" },
                    { new Guid("40000000-0000-0000-2224-000000000042"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 42, "İç Tank Kesim Listelerinin Hazırlanması" },
                    { new Guid("40000000-0000-0000-2224-000000000043"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 43, "DALGAKIRAN KESİM LİSTESİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2224-000000000044"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 44, "DALGAKIRAN TEKNİK RESİMLERİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2224-000000000045"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 45, "İÇ TANK GÖVDE MONTAJ & NOZUL& DABLİN & TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000046"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 46, "İç BORULAMA TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000047"), 1, 1m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 47, "Dış Tank Kesim Listelerinin Hazırlanması" },
                    { new Guid("40000000-0000-0000-2224-000000000048"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 48, "Dış TANK GÖVDE MONTAJ & NOZUL& DABLİN & TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000049"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 49, "İGM MONTAJ TEKNİK RESİM" },
                    { new Guid("40000000-0000-0000-2224-000000000050"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 50, "KİNG PİN & MEKANİK AYAK KESİM LİSTESİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2224-000000000051"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 51, "KİNG PİN & MEKANİK AYAK Teknik Resimlerinin HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2224-000000000052"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 52, "TANK AYAK MONTAJ TASARIMI & KİNG PİN & MEKANİK AYAK KESİM LİSTESİNİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2224-000000000053"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 53, "TANK AYAK MONTAJ TASARIMI & KİNG PİN & MEKANİK AYAK TEKNİK RESMİN HAZIRLANMASI" },
                    { new Guid("40000000-0000-0000-2224-000000000054"), 1, 4m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 54, "Şase Teknik Resimlerinin Hazırlanması" },
                    { new Guid("40000000-0000-0000-2224-000000000055"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 55, "KONSOL MONTAJ TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000056"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 56, "Dolap Kesim Listelerinin Hazırlanması" },
                    { new Guid("40000000-0000-0000-2224-000000000057"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 57, "DOLAP TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000058"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 58, "Dış BORULAMA TEKNİK RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000059"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 59, "NAKLİYE RESMİ" },
                    { new Guid("40000000-0000-0000-2224-000000000060"), 1, 2m, true, false, new Guid("22222222-2222-2222-2222-222222222224"), "Teknik Ressam", 60, "ASBUİLT" }
                });

            migrationBuilder.InsertData(
                table: "MaterialForms",
                columns: new[] { "Id", "ColdStretchYieldStrength", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "ElasticModulus", "FormType", "MaterialClass", "MaterialFamily", "MaterialId", "ModifiedBy", "ModifiedDate", "MomentOfInertia", "Norm", "Notes", "ProductStandard", "SectionArea", "SectionModulus", "Status", "StockCode", "SymbolicName", "TargetPrice", "ThicknessMax", "ThicknessMin", "UnitPrice", "WeldingFactor", "YieldFactorK" },
                values: new object[,]
                {
                    { new Guid("22222222-2222-2222-2222-222222222222"), null, "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1411), null, null, null, 0, "Carbon Steel", 1, new Guid("11111111-1111-1111-1111-111111111111"), null, null, null, "EN10028-2", "Standard plate form for P355GH", "EN 10028-2", null, null, 0, null, "P355GH", null, 250.0, 1.0, 1.5, null, null },
                    { new Guid("22222222-2222-2222-2222-222222222223"), null, "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1458), null, null, null, 1, "Carbon Steel", 1, new Guid("77777777-7777-7777-7777-777777777777"), null, null, null, "EN10216-3", "Seamless pipe form for P355NH", "EN 10216-3", null, null, 0, null, "P355NH", null, 40.0, 2.0, 2.2999999999999998, 1.0, null },
                    { new Guid("44444444-4444-4444-4444-444444444441"), 400.0, "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1446), null, null, null, 0, "Stainless Steel", 2, new Guid("33333333-3333-3333-3333-333333333333"), null, null, null, "EN10028-7", "Plate form for X5CrNi18-10 (Cold stretch optional)", "EN 10028-7", null, null, 0, null, "X5CrNi18-10", null, 200.0, 1.0, 4.5, null, null },
                    { new Guid("66666666-6666-6666-6666-666666666661"), null, "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1472), null, null, 206000.0, 4, "Carbon Steel", 1, new Guid("55555555-5555-5555-5555-555555555555"), null, null, 101700.0, "EN10025", "S235JR kutu profil 40x40x3 mm", "EN 10025-2", 444.0, 5080.0, 0, null, "S235JR", null, 30.0, 3.0, 1.2, null, 235.0 },
                    { new Guid("77777777-7777-7777-7777-777777777771"), null, "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1482), null, null, null, 2, "Carbon Steel", 1, new Guid("77777777-7777-7777-7777-777777777777"), null, null, null, "EN10028-3", "Forged part seed for P355NH", "EN 10028-3", null, null, 0, null, "P355NH", null, 300.0, 20.0, 2.7999999999999998, null, null },
                    { new Guid("88888888-8888-8888-8888-888888888881"), null, "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1492), null, null, null, 0, "Stainless Steel", 2, new Guid("88888888-8888-8888-8888-888888888888"), null, null, null, "EN10028-7", "Plate seed for X2CrNi18-9", "EN 10028-7", null, null, 0, null, "X2CrNi18-9", null, 120.0, 1.0, 4.9000000000000004, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("20000000-0000-0000-0000-000000000001"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2595), null, null, 688.0, 200.0, 4.9626999999999999, 1.0, 488.0, null, null, 2.3839999999999999, 0.25041999999999998, 2.4674, 0, new Guid("10000000-0000-0000-0000-000000000001"), -150.0 },
                    { new Guid("20000000-0000-0000-0000-000000000002"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2608), null, null, 281.19, 81.790000000000006, 2.4571000000000001, -0.1275, 199.40000000000001, null, null, 0.98999999999999999, 0.2215, 1.2352000000000001, 0, new Guid("10000000-0000-0000-0000-000000000002"), -196.0 },
                    { new Guid("20000000-0000-0000-0000-000000000003"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2623), null, null, 367.88, 200.0, 2.3632, 1.0, 167.88, null, null, 12.214, 0.02129, 1.0495000000000001, 0, new Guid("10000000-0000-0000-0000-000000000003"), -150.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("067553c7-cbf3-4217-b9d4-0ef46067125f"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1745), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 225.0, 0, 300.0, 40.0, 16.0 },
                    { new Guid("074d305c-0220-4d75-a17d-71a4c4c9a412"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1553), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 323.0, 0, 100.0, 16.0, 1.0 },
                    { new Guid("08f2fba8-e94b-4121-bc60-d3ba7077c3dc"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1814), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 315.0, 0, 20.0, 100.0, 60.0 },
                    { new Guid("0d161d81-65cf-4b10-8c6a-078796f86272"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2164), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 350.0, 0, -196.0, 120.0, 1.0 },
                    { new Guid("119cac94-da70-4d52-8e09-b244da1788d1"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2168), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 330.0, 0, -150.0, 120.0, 1.0 },
                    { new Guid("12b2908b-bb97-4b7c-97a5-5c715958db26"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1963), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 450.0, 167.0, 0, 400.0, 250.0, 150.0 },
                    { new Guid("12db22ea-d72b-455e-b6c2-6434176f4d0f"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1933), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 450.0, 249.0, 0, 150.0, 250.0, 150.0 },
                    { new Guid("14f7ef92-9dd1-4791-b0e4-1ec541d5518e"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2240), null, null, new Guid("22222222-2222-2222-2222-222222222223"), null, null, 490.0, 355.0, 0, 20.0, 40.0, 2.0 },
                    { new Guid("17b5d404-96b5-4536-982b-ef4dacda2cac"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2224), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 150.0, 0, 300.0, 120.0, 1.0 },
                    { new Guid("18c6fa9c-c056-44af-ad75-174afaa450f6"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1919), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 450.0, 295.0, 0, 20.0, 250.0, 150.0 },
                    { new Guid("1a1a90b8-67a2-41a8-8221-1245ee065ae0"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2288), null, null, new Guid("22222222-2222-2222-2222-222222222223"), null, null, 490.0, 202.0, 0, 400.0, 40.0, 2.0 },
                    { new Guid("1b207d5e-ae31-4e19-b355-ccf89bf98aaa"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1818), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 305.0, 0, 50.0, 100.0, 60.0 },
                    { new Guid("1e0b959f-e644-4785-af0b-70bbfb752ce7"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1570), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 252.0, 0, 250.0, 16.0, 1.0 },
                    { new Guid("1f79c445-31e6-437d-931b-0bd2565e07f1"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2248), null, null, new Guid("22222222-2222-2222-2222-222222222223"), null, null, 490.0, 343.0, 0, 50.0, 40.0, 2.0 },
                    { new Guid("22a54bbf-515a-4d5f-9e25-f15dcfffd9cc"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2138), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 160.0, 0, 250.0, 200.0, 1.0 },
                    { new Guid("23da30d9-abd8-420e-ac2c-d9516d25e44e"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1581), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 214.0, 0, 350.0, 16.0, 1.0 },
                    { new Guid("2873e5fd-7920-47f9-9765-6115a961de0e"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1829), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 265.0, 0, 150.0, 100.0, 60.0 },
                    { new Guid("28de72d2-6e4b-4c06-aba0-6bb80ac067fd"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1832), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 244.0, 0, 200.0, 100.0, 60.0 },
                    { new Guid("2b2473ed-2357-4982-9948-b93709835651"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2200), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 195.0, 0, 100.0, 120.0, 1.0 },
                    { new Guid("2b91ce98-f807-482b-b920-75d4d3fb4306"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2152), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 140.0, 0, 350.0, 200.0, 1.0 },
                    { new Guid("3293eeec-c1a9-496d-b585-038899428e44"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2175), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 300.0, 0, -100.0, 120.0, 1.0 },
                    { new Guid("32a5b5ce-4bfe-414f-8335-4cecbe68a13b"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1940), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 450.0, 228.0, 0, 200.0, 250.0, 150.0 },
                    { new Guid("381be4bb-1142-4723-a67f-9413c6ac38b3"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1810), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 470.0, 190.0, 0, 400.0, 60.0, 40.0 },
                    { new Guid("3858694d-fe8e-487e-8b7e-f5ca02cde776"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1853), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 190.0, 0, 350.0, 100.0, 60.0 },
                    { new Guid("38f0b9a9-0cf2-466e-bbfe-fd7565e040ed"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1558), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 299.0, 0, 150.0, 16.0, 1.0 },
                    { new Guid("3bf1676e-74a4-41de-8adb-fa7177683914"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1586), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 202.0, 0, 400.0, 16.0, 1.0 },
                    { new Guid("3cd51ccc-170c-42e5-996c-e65a515a1f58"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1752), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 208.0, 0, 350.0, 40.0, 16.0 },
                    { new Guid("44653d4e-7a47-4d03-aa99-fec032e57453"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1620), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 267.0, 0, 200.0, 40.0, 16.0 },
                    { new Guid("447d937c-a1be-4d58-863b-2e4ec5fc6ac0"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2272), null, null, new Guid("22222222-2222-2222-2222-222222222223"), null, null, 490.0, 252.0, 0, 250.0, 40.0, 2.0 },
                    { new Guid("4d8aee81-0beb-4253-ad6e-d9fa1221da87"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1894), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 216.0, 0, 250.0, 150.0, 100.0 },
                    { new Guid("4f068f43-03c7-4ff2-b4ba-27ab2e2d946b"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2121), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 195.0, 0, 100.0, 200.0, 1.0 },
                    { new Guid("537ff2ff-779b-43e9-904f-759d1c461dc3"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2258), null, null, new Guid("22222222-2222-2222-2222-222222222223"), null, null, 490.0, 299.0, 0, 150.0, 40.0, 2.0 },
                    { new Guid("54c451a4-2dbe-492f-a1ba-f1dd5b9f2d14"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1576), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 232.0, 0, 300.0, 16.0, 1.0 },
                    { new Guid("54d76e7c-2729-4da2-8b44-75596be62ce3"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1859), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 179.0, 0, 400.0, 100.0, 60.0 },
                    { new Guid("559a213d-09d0-4605-93e9-2a65d6aede72"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1798), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 470.0, 219.0, 0, 300.0, 60.0, 40.0 },
                    { new Guid("605bfb7d-1034-4f40-a3f6-c5e9e903d3b5"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1602), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 334.0, 0, 50.0, 40.0, 16.0 },
                    { new Guid("6108041f-3ede-46c9-b276-21da61465c4f"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1924), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 450.0, 285.0, 0, 50.0, 250.0, 150.0 },
                    { new Guid("6a0cc8bf-3071-450b-94b0-b8e38eabe48a"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2282), null, null, new Guid("22222222-2222-2222-2222-222222222223"), null, null, 490.0, 214.0, 0, 350.0, 40.0, 2.0 },
                    { new Guid("6bd2fc10-7d48-4234-a08a-b67b82f6857d"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2132), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 170.0, 0, 200.0, 200.0, 1.0 },
                    { new Guid("6d342e6c-bc28-4483-b2b3-8565c01b4d1f"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2253), null, null, new Guid("22222222-2222-2222-2222-222222222223"), null, null, 490.0, 323.0, 0, 100.0, 40.0, 2.0 },
                    { new Guid("7364913d-091d-43b2-8ef3-12f9fdf58d73"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2229), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 140.0, 0, 350.0, 120.0, 1.0 },
                    { new Guid("7e5df78b-b08c-43ef-b746-c79ec17ec607"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1847), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 206.0, 0, 300.0, 100.0, 60.0 },
                    { new Guid("7ea50bf4-d438-426e-93cb-f3c9d48c6879"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1956), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 450.0, 178.0, 0, 350.0, 250.0, 150.0 },
                    { new Guid("827704df-772a-42ee-85e6-f798058cfa04"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1968), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 350.0, 0, -196.0, 200.0, 1.0 },
                    { new Guid("82d33803-c32a-406f-bb8c-65fe65a830ce"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1981), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 300.0, 0, -100.0, 200.0, 1.0 },
                    { new Guid("84a9e58f-70f6-4de5-ae78-f3b1154128d9"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1772), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 470.0, 324.0, 0, 50.0, 60.0, 40.0 },
                    { new Guid("8639386d-ed97-4e80-a0b4-69742bade607"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2104), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 260.0, 0, -50.0, 200.0, 1.0 },
                    { new Guid("87427867-aa74-4736-b257-00d0f6d1fc6e"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1595), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 345.0, 0, 20.0, 40.0, 16.0 },
                    { new Guid("913c2a11-6ab4-4b43-9791-7908631087c6"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2192), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 205.0, 0, 50.0, 120.0, 1.0 },
                    { new Guid("9abcbd26-40fe-410d-a5da-e5d98665bb79"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2157), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 130.0, 0, 400.0, 200.0, 1.0 },
                    { new Guid("9b0c1d7d-f5f4-460d-aeac-a1b3ea9ccd13"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2186), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 210.0, 0, 20.0, 120.0, 1.0 },
                    { new Guid("9c512ad7-0213-4052-839e-e4e93ca8f9b7"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1784), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 470.0, 282.0, 0, 150.0, 60.0, 40.0 },
                    { new Guid("9e554b5f-a42f-49a7-94e7-f0e45fb294d6"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2128), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 185.0, 0, 150.0, 200.0, 1.0 },
                    { new Guid("9fa8c814-15c0-4dfe-b0c0-cad582af04dd"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1793), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 470.0, 238.0, 0, 250.0, 60.0, 40.0 },
                    { new Guid("a76ae491-ec31-41d0-91c6-c3e9ef8bb168"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1805), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 470.0, 202.0, 0, 350.0, 60.0, 40.0 },
                    { new Guid("ac6a4e80-5c45-48b8-a1e8-0273b80ab50c"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1876), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 277.0, 0, 100.0, 150.0, 100.0 },
                    { new Guid("b27ead01-2123-42c1-8380-51a147323a68"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2216), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 160.0, 0, 250.0, 120.0, 1.0 },
                    { new Guid("b354ce4e-4e5c-4cfb-90bd-d30ba0d16ea7"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1882), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 257.0, 0, 150.0, 150.0, 100.0 },
                    { new Guid("b7a17353-eafe-4f4d-936f-a70df91178b6"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1887), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 236.0, 0, 200.0, 150.0, 100.0 },
                    { new Guid("b7b41c1e-6c8d-4ecf-8c9a-4d8be905b059"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2277), null, null, new Guid("22222222-2222-2222-2222-222222222223"), null, null, 490.0, 232.0, 0, 300.0, 40.0, 2.0 },
                    { new Guid("b94db6d9-f98b-4979-b249-fd5f833fd5e9"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1911), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 173.0, 0, 400.0, 150.0, 100.0 },
                    { new Guid("b9a97d42-8cc2-45d1-b941-b4325451ba48"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2296), null, null, new Guid("66666666-6666-6666-6666-666666666661"), null, null, 360.0, 235.0, 0, 20.0, 30.0, 3.0 },
                    { new Guid("be6abfd4-b412-4e97-8e0b-3c2f99c7e105"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1612), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 291.0, 0, 150.0, 40.0, 16.0 },
                    { new Guid("c1397924-6abe-4602-9c8f-c073e902d216"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1906), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 184.0, 0, 350.0, 150.0, 100.0 },
                    { new Guid("c3903bfe-2044-4314-ac1f-c75f4b587122"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1761), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 196.0, 0, 400.0, 40.0, 16.0 },
                    { new Guid("c4d9f895-fd84-461e-b59a-34a0a3bdebcb"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2264), null, null, new Guid("22222222-2222-2222-2222-222222222223"), null, null, 490.0, 275.0, 0, 200.0, 40.0, 2.0 },
                    { new Guid("c52d3447-1f6c-469d-889a-9fb80bf753f5"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1740), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 245.0, 0, 250.0, 40.0, 16.0 },
                    { new Guid("c7b014d0-378d-4c2e-b3b6-9e7ec0409488"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1945), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 450.0, 209.0, 0, 250.0, 250.0, 150.0 },
                    { new Guid("caa4adfc-e348-4e44-a403-abb9eabd9913"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1789), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 470.0, 259.0, 0, 200.0, 60.0, 40.0 },
                    { new Guid("cc32c2de-bc62-4e5b-bf00-4c13f8283369"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1537), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 355.0, 0, 20.0, 16.0, 1.0 },
                    { new Guid("cd0dd8f8-c086-4eda-96bb-ad219329e06c"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1825), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 287.0, 0, 100.0, 100.0, 60.0 },
                    { new Guid("cd9b6902-b5a6-4d5e-aa6a-1288339502e0"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1865), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 305.0, 0, 20.0, 150.0, 100.0 },
                    { new Guid("ce8b6133-6612-48b0-b1d2-a707af33292d"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2180), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 260.0, 0, -50.0, 120.0, 1.0 },
                    { new Guid("cea4a8a7-e555-48e5-a819-de39fb67ed54"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1951), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 450.0, 192.0, 0, 300.0, 250.0, 150.0 },
                    { new Guid("d1e00181-f6d7-4d29-a0a5-b4dbc479f897"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1974), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 330.0, 0, -150.0, 200.0, 1.0 },
                    { new Guid("d22703b8-dd74-4098-9688-f60d6c01ded8"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1929), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 450.0, 268.0, 0, 100.0, 250.0, 150.0 },
                    { new Guid("d4c1670a-4434-4cd5-bad4-726f3debf4c8"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1548), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 343.0, 0, 50.0, 16.0, 1.0 },
                    { new Guid("db16590d-dbdd-438f-b68f-18dc874ae8f3"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1777), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 470.0, 305.0, 0, 100.0, 60.0, 40.0 },
                    { new Guid("db9ec620-7c0c-41c0-85e7-f25c9765d13e"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2235), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 130.0, 0, 400.0, 120.0, 1.0 },
                    { new Guid("dd677f8f-77b0-45ea-ad19-c3b53361fe22"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2211), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 170.0, 0, 200.0, 120.0, 1.0 },
                    { new Guid("e0ae500c-f6ef-47b0-a932-1bc526e552dd"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2205), null, null, new Guid("88888888-8888-8888-8888-888888888881"), null, null, 650.0, 185.0, 0, 150.0, 120.0, 1.0 },
                    { new Guid("e5745aca-45c1-4f53-b070-f39f4f606fdd"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2115), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 205.0, 0, 50.0, 200.0, 1.0 },
                    { new Guid("eda097c8-8082-46a3-b1aa-102b9d484c8a"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2143), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 150.0, 0, 300.0, 200.0, 1.0 },
                    { new Guid("efd91ef5-db56-4b76-a2ce-3213af973a95"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1872), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 295.0, 0, 50.0, 150.0, 100.0 },
                    { new Guid("f14f509a-f09c-47b8-8e25-dc0e0898a5c9"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(2109), null, null, new Guid("44444444-4444-4444-4444-444444444441"), null, null, 650.0, 210.0, 0, 20.0, 200.0, 1.0 },
                    { new Guid("f18a9772-1c6c-404d-9842-37203901898a"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1836), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 224.0, 0, 250.0, 100.0, 60.0 },
                    { new Guid("f29042a0-ea06-4a36-84b6-839b6a7b3ad3"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1607), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 314.0, 0, 100.0, 40.0, 16.0 },
                    { new Guid("f76d96db-b08f-43fe-85b0-8fbd93c095bf"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1767), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 470.0, 335.0, 0, 20.0, 60.0, 40.0 },
                    { new Guid("fa86758e-e92a-431b-aa49-d002726e4c32"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1900), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 460.0, 199.0, 0, 300.0, 150.0, 100.0 },
                    { new Guid("ff665056-4733-4d92-92be-2e06e536d349"), "SeedData", new DateTime(2026, 5, 17, 10, 37, 5, 470, DateTimeKind.Utc).AddTicks(1563), null, null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, 490.0, 275.0, 0, 200.0, 16.0, 1.0 }
                });
