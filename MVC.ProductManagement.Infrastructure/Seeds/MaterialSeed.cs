        ...
        public static List<Material> Get()
        {
            return new List<Material>
            {
                new Material
                {
                    ...
                    Name = "P355GH",
                    Grade = "P355GH",
                    MaterialFamilyId = MaterialCatalogSeed.CarbonSteelFamilyId,
                    IsActive = true,
                ...
                new Material
                {
                    ...
                    Name = "X5CrNi18-10",
                    Grade = "1.4301",
                    MaterialFamilyId = MaterialCatalogSeed.StainlessSteelFamilyId,
                    IsActive = true,
                ...
                new Material
                {
                    ...
                    Name = "P355NH",
                    Grade = "P355NH",
                    MaterialFamilyId = MaterialCatalogSeed.LowTemperatureCarbonSteelFamilyId,
                    IsActive = true,
                    MaterialNumber = "1.0565",
                    Density = 7850,
