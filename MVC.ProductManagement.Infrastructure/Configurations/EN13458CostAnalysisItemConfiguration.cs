...
{
    public class EN13458CostAnalysisItemConfiguration : IEntityTypeConfiguration<EN13458CostAnalysisItem>
    {
        public void Configure(EntityTypeBuilder<EN13458CostAnalysisItem> builder)
        {
            ...
            builder.HasIndex(x => x.EN13458CostAnalysisId);
            builder.HasIndex(x => new { x.EN13458CostAnalysisId, x.ItemKey });
        }
    }
}
