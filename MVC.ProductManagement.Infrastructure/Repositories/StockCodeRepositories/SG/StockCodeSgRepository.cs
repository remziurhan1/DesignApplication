...
namespace MVC.ProductManagement.Infrastructure.Repositories.StockCodeRepositories.SG
{
    public class StockCodeSgRepository : IStockCodeSgService
    {
